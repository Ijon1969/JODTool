 ...
 */
public class VdmrtWordRule extends SingleLineRule {
	 ...
	 */
    protected VdmrtWordRule(String sequence, IToken token, char escapeCharacter, boolean breaksOnEOF, boolean escapeContinuesLine) {
     ...
     * @param breaksOnEOF
     */
    protected VdmrtWordRule(String sequence, IToken token, char escapeCharacter, boolean breaksOnEOF) {
     ...
     * @param escapeCharacter
     */
    protected VdmrtWordRule(String sequence, IToken token, char escapeCharacter) {
     ...
     * @param token
     */
    protected VdmrtWordRule(String sequence, IToken token) {
