 ...
 */
public class DownHandler extends AbstractHandler implements IHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		List<Entry> entries = tab.getSelections();
		if (entries == null || entries.isEmpty()) {
			return null;
		}

		// 行の移動
//		tab.moveEntry(entry, false);
		tab.moveEntries(entries, false);
