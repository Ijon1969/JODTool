 ...
 * </p>
 */
public abstract class IconAndLinkDialog extends Dialog {
	/**
	 * Message (a localized string).
	 */
	protected String message;

	protected Map<String, String> messageLinkMap;
	 ...
	 *            shell
	 */
	public IconAndLinkDialog(Shell parentShell) {
		super(parentShell);
	}
	...
	protected Control createMessageArea(Composite composite) {
		...
		// create message
		if (message != null) {
			messageLink = new Link(composite, getMessageLinkStyle());
			...
			messageLink.addSelectionListener(new SelectionAdapter() {
				public void widgetSelected(SelectionEvent e) {
					PreferenceDialog dialog = PreferencesUtil.createPreferenceDialogOn(
							getShell(), messageLinkMap.get(e.text), null, null);
					dialog.open();
				}
			});
		}
	 ...
	 * @since 3.0
	 */
	protected int getMessageLinkStyle() {
		return SWT.WRAP;
	}
