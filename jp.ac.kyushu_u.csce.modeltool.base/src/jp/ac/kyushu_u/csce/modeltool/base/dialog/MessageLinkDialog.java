 ...
 * </p>
 */
public class MessageLinkDialog extends IconAndLinkDialog {
	/**
	 * Constant for no image (value 0).
	 *
	 * @see #MessageLinkDialog(Shell, String, Image, String, Map, int, String[], int)
	 */
	 ...
	 *
	 * @see #MessageLinkDialog(Shell, String, Image, String, Map, int, String[], int)
	 * @see #open(int, Shell, String, String, Map, int)
	 */
	 ...
	 */
	public MessageLinkDialog(Shell parentShell, String dialogTitle,
			Image dialogTitleImage, String dialogMessage, Map<String, String> messageLinkMap,
			int dialogImageType, String[] dialogButtonLabels, int defaultIndex) {
		super(parentShell);
		this.title = dialogTitle;
		this.titleImage = dialogTitleImage;
		this.message = dialogMessage;
		this.messageLinkMap = messageLinkMap;
	...
	public static boolean open(int kind, Shell parent, String title,
			String message, Map<String, String> messageLinkMap, int style) {
		MessageLinkDialog dialog = new MessageLinkDialog(parent, title, null, message,
				messageLinkMap, kind, getButtonLabels(kind), 0);
		style &= SWT.SHEET;
	 ...
	 *         <code>false</code> otherwise
	 */
	public static boolean openConfirm(Shell parent, String title, String message, Map<String, String> messageLinkMap) {
		return open(CONFIRM, parent, title, message, messageLinkMap, SWT.NONE);
	}
	 ...
	 *            the message
	 */
	public static void openError(Shell parent, String title, String message, Map<String, String> messageLinkMap) {
		open(ERROR, parent, title, message, messageLinkMap, SWT.NONE);
	}
	...
	public static void openInformation(Shell parent, String title,
			String message, Map<String, String> messageLinkMap) {
		open(INFORMATION, parent, title, message, messageLinkMap, SWT.NONE);
	}
	...
	public static boolean openQuestion(Shell parent, String title,
			String message, Map<String, String> messageLinkMap) {
		return open(QUESTION, parent, title, message, messageLinkMap, SWT.NONE);
	}
	 ...
	 *            the message
	 */
	public static void openWarning(Shell parent, String title, String message, Map<String, String> messageLinkMap) {
		open(WARNING, parent, title, message, messageLinkMap, SWT.NONE);
	}
