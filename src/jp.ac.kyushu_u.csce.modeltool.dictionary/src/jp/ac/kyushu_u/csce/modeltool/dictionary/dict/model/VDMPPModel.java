...
/* 2014/11/17 クラス名変更 VDMModel ⇒ VDMPPModel  */
/**
 * VDM++モデルクラス
 *
 * @author KBK yoshimura
 */
public class VDMPPModel extends Model {
...
//	/** 種別（コード） */
//	private static final int[] SECTION_CDS = {
//			1,
//			2,
//			3,
//			4,
...
//			Messages.VDMModel_0,		// 1
//			Messages.VDMModel_1,		// 2
//			Messages.VDMModel_2,		// 3
//			Messages.VDMModel_3,		// 4
//			Messages.VDMModel_4,		// 5
//			Messages.VDMModel_5,		// 6
//	};
//
//	/** 種別背景色設定フラグ */
//	private static final boolean[] PREF_SECTION_BG = {
//			true,		// 1
//			false,		// 2
//			false,		// 3
//			false,		// 4
...
//	};
	...
	{
		errorMap.put(E_NO_SECTION,			Messages.VDMPPModel_8);
		errorMap.put(E_NO_DEFINITION,		Messages.VDMPPModel_9);
		errorMap.put(E_CLASS_UNKNOWN,		Messages.VDMPPModel_10);
		errorMap.put(E_WRONG_DEFINITION,	Messages.VDMPPModel_11);
		errorMap.put(E_CLASS_WRONG,			Messages.VDMPPModel_12);
	}
