 ...
 */
public abstract class AbstractVdmrtSearchHandler extends AbstractHandler {
    ...
    public Object execute(ExecutionEvent event) throws ExecutionException {
        ...
        if(editor instanceof VdmrtEditor == false) {
        	// VDMエディター以外のエディターでは処理を行わない
        	showWarningDialog(Messages.AbstractVdmrtSearchHandler_0);
        	return null;
        }
        ...
        if(dicView == null) {
        	showWarningDialog(Messages.AbstractVdmrtSearchHandler_1);
            return null;
        }
        // 辞書ビューをフォーカス
        ...
        // 検索処理実行
        Object ret = doExecute(event, (VdmrtEditor)editor, dicView);
     ...
     * @return
     */
    protected abstract Object doExecute(ExecutionEvent executionevent, VdmrtEditor vdmeditor, DictionaryView dictionaryview);
    ...
    protected String getMessageTitle() {
		return Messages.AbstractVdmrtSearchHandler_2;
	}
